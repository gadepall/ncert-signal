...
\begin{table}[htbp]
    ...
    \input{ncert-physics/11/14/12/tables/table1}
    \caption{Input table}
...
\end{align}
\begin{figure}[!htbp]
    \input{ncert-physics/11/14/12/figs/sol_1}
\end{figure}
\item \begin{align}
    x = \cos\left(\frac{\pi}{6} - t\right)
\end{align}
\begin{figure}[!htbp]
    \input{ncert-physics/11/14/12/figs/sol_2}
\end{figure}
...
\end{align}
\begin{figure}[!htbp]
    \input{ncert-physics/11/14/12/figs/sol_3}
\end{figure}
...
\end{align}
\begin{figure}[!htbp]
    \input{ncert-physics/11/14/12/figs/sol_4}
\end{figure}
