...
\item  A coil of inductance 0.50 H and resistance 100 Ω is connected to a 240 V, 50 Hz ac supply.
(a) What is the maximum current in the coil?
(b) What is the time lag between the voltage maximum and the
current maximum? Obtain the answers (a) to (b) in Exercise 7.13 if the circuit is
