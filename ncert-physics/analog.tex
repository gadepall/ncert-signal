...
\begin{figure}[!h]
	\centering
	\input{ncert-physics/12/7/6/figs/fig1.tex}
	\caption{LCR Circuit}
\end{figure}
\solution
\input{ncert-physics/12/7/6/6.tex}
\pagebreak
...
\end{enumerate}
\solution
\input{ncert-physics/12/7/11/main.tex}
\pagebreak
...
\solution
\input{ncert-physics/12/8/4/em.tex}
\pagebreak
...
\end{figure}\\
\solution
\input{ncert-physics/11/14/9/assign11_14_9.tex}
\pagebreak
...
\end{circuitikz}
 \solution
 \input{ncert-physics/12/7/17/main.tex}
 \pagebreak
...
\solution
\input{ncert-physics/11/14/7/main.tex}
\pagebreak
...
\solution
\input{ncert-physics/11/14/12/main.tex}
\pagebreak
\end{enumerate}
