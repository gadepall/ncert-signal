...
\begin{table}[!h]
	\centering
	\input{ncert-physics/12/7/15/tables/table1.tex}
	\vspace{6 pt}
...
\begin{figure}[!h]
	\centering
	\input{ncert-physics/12/7/15/figs/fig1.tex}
	\caption{RC Circuit}
...
\begin{figure}[!h]
	\centering
	\input{ncert-physics/12/7/15/figs/fig2.tex}
	\caption{RC Circuit}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 2.4 in, height = 1.6 in]{ncert-physics/12/7/15/figs/fig4.png}
    \caption{Current vs $\omega$}
    \label{fig:12.7.15.40}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 2.4 in, height = 1.6 in]{ncert-physics/12/7/15/figs/fig3.png}
    \caption{Impedance vs $\omega$}
    \label{fig:12.7.15.50}
\end{figure}
\end{enumerate}
