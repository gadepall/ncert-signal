...
\fi
 \begin{table}[h]
 	\centering
 	\resizebox{6 cm}{!}{
 		\input{ncert-physics/12/7/6/tables/table1.tex}
 	}
 	\vspace{6 pt}
 	\caption{Parameters}
 	\label{tab: 12.7.6tableswa} 
 \end{table}
 
\begin{figure}[!h]
 \centering
    \input{ncert-physics/12/7/6/figs/fig2.tex}
    \caption{LCR Circuit}
    \label{fig: 12.7.6swafig2}
\end{figure}
