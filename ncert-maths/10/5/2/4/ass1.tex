...
\begin{table}[h!]
\centering
\input{ncert-maths/10/5/2/4/tables/tab.tex}
...
k &= 15
\end{align}
So, the term of the arithmetic progression that is equal to \(78\) is the \(16\)th term.
\begin{align}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\linewidth]{ncert-maths/10/5/2/4/figs/plot_with_highlight.png}
