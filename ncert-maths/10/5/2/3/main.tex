...
\solution
\fi
\input{ncert-maths/11/5/2/3/Tables/table.tex}
...
\begin{figure}[h]
       \centering
        \includegraphics[width=1\linewidth]{ncert-maths/11/5/2/3/figs/plot1.png} % Adjust the width as needed
        \caption{}
\end{figure}

\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{ncert-maths/11/5/2/3/figs/plot2.png} % Adjust the width as needed
        \caption{}
    \end{figure}
    
\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{ncert-maths/11/5/2/3/figs/plot3.png} % Adjust the width as needed
        \caption{}
    \end{figure}
    
\begin{figure}[h] 
      \centering
       \includegraphics[width=1\linewidth]{ncert-maths/11/5/2/3/figs/plot4.png} % Adjust the width as needed
        \caption{}
    \end{figure}
    
\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{ncert-maths/11/5/2/3/figs/plot5.png} % Adjust the width as needed
        \caption{}
\end{figure}
%\end{document}
