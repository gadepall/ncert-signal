...
\hhline{|-|-|-|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$n^{th}$ term of discrete signal}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{(x(0)+nd)u(n)}}
\\
\hhline{|-|-|-|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{x(0)}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$1^{st}$ term of the AP}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|-|-|-|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{Common Difference of the AP}}
	&\multicolumn{1}{p{\gnumericColC}|}%
