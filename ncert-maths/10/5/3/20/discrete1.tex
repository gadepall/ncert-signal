...
\begin{table}
  ...
  \input{ncert-maths/10/5/3/20/tables/table2.tex}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{ncert-maths/10/5/3/20/figs/plot1.png}
    \caption{Stem plot of x(n)}
    \label{fig:10.5.3.20fig1}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{ncert-maths/10/5/3/20/figs/plot2.png}
