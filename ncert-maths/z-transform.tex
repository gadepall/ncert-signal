...
\solution
\input{ncert-maths/11/9/5/21/a2.tex}
\pagebreak
...
\solution
\input{ncert-maths/11/9/5/25/main.tex}
\pagebreak
...
\solution
\input{ncert-maths/11/9/2/14/main.tex}
\pagebreak
...
\solution
\input{ncert-maths/11/9/2/9/ap.tex}
\pagebreak
...
\solution
\input{ncert-maths/11/9/3/23/main.tex}
\pagebreak
...
\solution
\input{ncert-maths/11/9/4/5/main.tex}
\pagebreak
...
\item The sum of first three terms of a G.P. is 16 and the sum of next three terms is 128. Determine the first term, the common ratio, and the sum to $n$ terms of the G.P.\\
\solution
\input{ncert-maths/11/9/3/14/ass2.tex}
\pagebreak
\item     Find the sum to $n$ terms of the series whose $n$th term is given by $n^2 + 2^n$?\\
\solution\\
\input{ncert-maths/11/9/4/9/assq2.tex}
\pagebreak
\end{enumerate}
