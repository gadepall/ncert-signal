...
\item 200 logs are stacked in the following     manner: 20 logs in the bottom row, 1    9 in the next row,
 51 18 in the row next to it and so on .
    In how many rows are the 200 logs pla    ced                                   52 and how many logs are in the top row?\\
\solution
\input{ncert-maths/10/5/3/19/seq17.tex}
\end{enumerate}
