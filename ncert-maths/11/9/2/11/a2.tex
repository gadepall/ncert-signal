...
\begin{table}[h]
    \centering
    \input{ncert-maths/11/9/2/11/tables/table1.tex}
...
Using y\brak{n},
\begin{align}
    a&=\dfrac{p}{2}\brak{2x\brak{0}+\brak{p-1}d}\label{eq:11.9.2.11.4}\\
    b&=\dfrac{q}{2}\brak{2x\brak{0}+\brak{q-1}d}\label{eq:11.9.2.11.5}\\
    c&=\dfrac{r}{2}\brak{2x\brak{0}+\brak{r-1}d}\label{eq:11.9.2.11.6}
\end{align}
...
\begin{align}
    \myvec{p&\frac{p\brak{p-1}}{2}&a\\q&\frac{q\brak{q-1}}{2}&b\\r&\frac{r\brak{r-1}}{2}&c\\}\vec{x}=0\label{eq:11.9.2.11.7}
\end{align}
where,
\begin{align}
    \vec{x}=\myvec{x\brak{0}\\d\\-1}
\end{align}
solving the equations \eqref{eq:11.9.2.11.4},\eqref{eq:11.9.2.11.5} and \eqref{eq:11.9.2.11.6} by row reducing the matrix in $\eqref{eq:11.9.2.11.7}$,
    \begin{align}
    \myvec{
...
\begin{table}[ht]
    ...
    \input{ncert-maths/11/9/2//11/tables/table2.tex}
