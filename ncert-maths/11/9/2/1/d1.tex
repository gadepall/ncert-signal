...
\vspace{3cm}
	...
	\author{EE23BTECH11216 - PILLI KALYAN$^{*}$% <-this % stops a space
	}
\maketitle
\newpage
\bigskip
...
\begin{table}[h]
	\centering
	 	...
	 	\input{ncert-maths/11/9/2/1/tables/table.tex}
...
\begin{figure}[h!]
\centering
\includegraphics[width=\columnwidth]{ncert-maths/11/9/2/1/figs/main.png}
\label{fig:11.9.2.1.2}
