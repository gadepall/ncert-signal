...
\begin{table}[h!]
    \centering
    \input{ncert-maths/11/9/5/21/tables/table1.tex}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\columnwidth]{ncert-maths/11/9/5/21/figs/data_x1.png}
    \caption{Stem plot of $s_1(n)$}
    \label{fig: sr4}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=\columnwidth]{ncert-maths/11/9/5/21/figs/data_x2.png}
