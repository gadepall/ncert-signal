...
\item In an A.P. the first term is 2 and the sum of the first five terms is one-fourth of the next five terms. Show that 20$\textsuperscript{th}$ term is -112. \\
\solution
\pagebreak

\item A man deposited Rs 10000 in a bank at the rate of 5\% simple interest annually. Find the amount in 15$\textsuperscript{th}$ year since he deposited the amount also calculate the total amount after 20 years. \\
\solution
\pagebreak
