...
\solution
\input{ncert-maths/10/5/3/17/SS-A2.tex}
\pagebreak
...
\solution
\input{ncert-maths/11/9/5/4/main.tex}
\pagebreak
...
\end{enumerate}
\solution
\input{ncert-maths/10/5/3/1/main.tex}
\pagebreak

\item Evaluate $\sum_{k=1}^{11} (2 + 3^k)$.
\solution
\input{ncert-maths/11/9/3/11/111.tex}
\pagebreak
\item Find the sum of odd numbers in $1$ to $2001$.
\solution
\input{ncert-maths/11/9/2/1/d1.tex}
\pagebreak
\end{enumerate}
